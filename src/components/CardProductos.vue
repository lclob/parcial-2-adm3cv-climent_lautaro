<template>
  <v-sheet dark class="elevation-5 py-5" id="home" min-height="calc(100vh - 124px)">
    <v-container>
      <h2>Productos</h2>
      <v-row justify="start">
        <v-card v-for="producto in productos" :key="producto.id" class="mx-auto d-flex flex-column" max-width="280">
...
export default {
  data: () => ({
    productos: [
      {
        id: 0,
        titulo: 'Surfboard Rusty The Keg 6',
        precio: 60000,
      ...
      {
        id: 3,
        titulo: 'Surfboard Rusty Moby Fish 6',
        precio: 90000,
...
<template>
  <v-sheet dark class="elevation-5 py-5" min-height="100vh">
    <v-container>
      <v-row justify="start">
